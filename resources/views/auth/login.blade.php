                        ...
                        <div class="col-10">
                            <div class="p-6">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-4">{{ config('app.name', 'Company') }}</h1>
                                </div>
                                <form class="user" method="POST" action="{{ route('admin.login') }}">
                                    @csrf
                                    <div class="form-group">
                                        <input type="text" name="username" class="form-control form-control-user"  placeholder="Login" required autofocus />
                                    </div>
                                    <div class="form-group">
